...
{
//$zipcode = 'London';
$qury = "use 'store://lKF2BveXrWtPdrlM4Il893' as quotes; select * from quotes where symbol in ('$symbol')"; //"select * from weather.forecast where woeid in (select woeid from geo.places where text='$zipcode' and placetype='town' limit 1)";
...
//print_r($phpObj);
$qObj = $phpObj->query->results->quote;
